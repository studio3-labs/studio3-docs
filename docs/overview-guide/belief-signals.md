...
<p>You think the venture should go ahead, or should take this option.</p>
...
<p>You think the venture should not go ahead, or should take the other option.</p>
...
```mermaid
flowchart TD
    A[Milestone declared in the Arena] --> B[Window opens]
    B --> C[Echoes signal support or doubt]
    B --> D[Echoes forecast the outcome]
    C --> E[Founder sees what the community wants]
    D --> F[Work period]
    E --> F
